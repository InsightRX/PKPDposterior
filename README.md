...
The software is provided as-is, and use of this software in any context is the sole responsibility of the user. InsightRX nor any of its employees can be held liable for any damages stemming directly or indirectly from the use of this software.
